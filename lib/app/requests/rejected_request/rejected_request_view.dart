...
class RejectedRequestView extends StatefulWidget {
  @override
  _RejectedRequestViewState createState() => _RejectedRequestViewState();
}

class _RejectedRequestViewState extends State<RejectedRequestView> {
  final RejectedRequestLogic logic = Get.put(RejectedRequestLogic());
  final RejectedRequestState state = Get.find<RejectedRequestLogic>().state;

  @override
  void dispose() {
    Get.delete<RejectedRequestLogic>();
    super.dispose();
  }
    ...
    return Obx(
      () => Center(
        child: state.gettingState.value
            ? MyIndicator()
            : GetBuilder<RejectedRequestLogic>(builder: (logic) {
