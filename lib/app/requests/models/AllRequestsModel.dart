class AllRequestsModel {
  ...
  AllRequestsModel.fromJson(dynamic json) {
    status = json['status'];
    errNum = json['errNum'];
    msg = json['msg'];
    if (json['ads'] != null) {
...
class RequestAds {
  ...
  Map<String, dynamic> toJson() {
    ...
    map['reqest_updated_at'] = reqestUpdatedAt;
    map['id'] = id;
    map['name_A'] = nameA;
    map['name_E'] = nameE;
    map['video'] = video;
