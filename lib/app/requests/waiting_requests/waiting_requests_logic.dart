...
class WaitingRequestsLogic extends GetxController {
  final state = WaitingRequestsState();
  ...
  void getPage() async {
    changePageState();
    var result =
        await state.requestsHttp.getWaitingAds(api: myOrdersWaittingAPI);
  ...
  void updatePage()async{
    var result = await state.requestsHttp.getWaitingAds(api: myOrdersWaittingAPI);
    result.fold((l) => pageError(l), (r) => pageDone(r));
    update();
  }
