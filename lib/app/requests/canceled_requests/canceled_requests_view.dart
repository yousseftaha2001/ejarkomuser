...
import 'canceled_requests_logic.dart';
import 'canceled_requests_state.dart';

class CanceledRequestsView extends StatefulWidget {
  @override
  _CanceledRequestsViewState createState() => _CanceledRequestsViewState();
}

class _CanceledRequestsViewState extends State<CanceledRequestsView> {
  final CanceledRequestsLogic logic = Get.put(CanceledRequestsLogic());
  final CanceledRequestsState state = Get.find<CanceledRequestsLogic>().state;

  @override
  void dispose() {
    Get.delete<CanceledRequestsLogic>();
    super.dispose();
  }
    ...
    return Obx(
      () => Center(
        child: state.gettingState.value
            ? MyIndicator()
            : GetBuilder<CanceledRequestsLogic>(builder: (logic) {
