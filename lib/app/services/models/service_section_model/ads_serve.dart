...
class AdsServe {
  ...
  factory AdsServe.fromMap(Map<String, dynamic> data) => AdsServe(
        id: data['id'] as num?,
        ...
        typeServes: data['type_serves'] as num?,
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [AdsServe].
  factory AdsServe.fromJson(String data) {
    return AdsServe.fromMap(json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [AdsServe] to a JSON string.
