...
class OneSerivce {
  ...
  factory OneSerivce.fromMap(Map<String, dynamic> data) => OneSerivce(
        id: data['id'] as num?,
  ...
  factory OneSerivce.fromJson(String data) {
    return OneSerivce.fromMap(json.decode(data) as Map<String, dynamic>);
  }
