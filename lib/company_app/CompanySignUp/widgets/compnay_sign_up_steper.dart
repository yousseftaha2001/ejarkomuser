import 'package:ejarkom/company_app/CompanySignUp/controller.dart';
...
class SignUpSteperCompany extends StatelessWidget {
  SignUpSteperCompany({super.key});
  final logic = Get.find<CompanysignupController>();
  final state = Get.find<CompanysignupController>().state;
