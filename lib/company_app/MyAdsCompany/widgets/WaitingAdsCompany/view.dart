                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              ...
                                              SizedBox(width: 6.w),
                                              Text(
                                                controller.state.ads[index].numRoom!.toString(),
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              SizedBox(width: 6.w),
                                              Text(
                                                controller.state.ads[index].numBathroom!
                                                    .toString(),
                                                style: Get.textTheme.bodyText1!
                                                    .copyWith(
                                                  color: Get.theme.primaryColor,
                                      ...
                                      Row(
                                        children: [
                                          Text(
                                           isEnglish()? controller.state.ads[index].nameE!:controller.state.ads[index].nameA!,
                                            style: Get.textTheme.bodyText1!
                                                .copyWith(
                                              color: Get.theme.primaryColor,
                                              fontWeight: FontWeight.bold,
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          const Spacer(),
                                          Text(
                                            '${controller.state.ads[index].cost}\$',
                                            style: Get.textTheme.bodyText1!
                                                .copyWith(
                                              color: Colors.amber,
                                              fontSize: 40.sp,
