                            ...
                            children: [
                              SizedBox(
                                ...
                                child: PageView.builder(
                                  ...
                                  itemCount: controller.state.ads!
                                      .getAllPhoto()
                                      .length,
                                  controller: controller.state.pageControlle,
                                  onPageChanged: (index) {
                                    controller.state.currentImages.value =
                                        index;
                                                ...
                                                controller
                                                    ...
                                                    : Row(
                                                        ...
                                                        controller
                                                                    .state
                                                                    .ads!
                                                                    .numRoom.toString()=='0'?Container():   Row(
                                                            children: [
                                                              Icon(
                                                                Icons
                                                         ...
                                                         controller
                                                                    .state
                                                                    .ads!
                                                                    .numBathroom.toString()=='0'?Container():  Row(
                                                            children: [
                                                              Icon(
                                                                Icons
                                                                    .bathroom_outlined,
                                                                ...
                                                                child: Text(
                                                                  isEnglish()
                                                                      ...
                                                                      : controller
                                                                          ...
                                                                          .descA!,
                                                                  maxLines:
                                                                      controller.state.containerIsOpened.value ==
                                                                              2
                                                                          ? null
                                                                          : 2,
                                                                  softWrap: controller
